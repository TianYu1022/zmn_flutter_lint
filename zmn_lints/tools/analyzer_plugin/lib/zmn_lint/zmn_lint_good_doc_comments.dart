...
class ZmnLintGoodDocComments extends DartLint {
  @override
  String get code => 'good_doc_comments';

  @override
  String get message => '【推荐】错误的注释格式。公共 api 使用 (/// xxx)， 其他情况使用 (// xxx) \n wrong comments format. (/// xxx) for public api and (// xxx) for other cases.';
    ...
    while (precedingComments != null) {
      ...
      if (precedingComments is DocumentationCommentToken) {
        if ((!value.startsWith('/// ') &&
                ...
                !(value == '///' && (precedingComments.previous != null || precedingComments.next != null))) ||
      ...
      // is //
        ...
        if (
            //node.parent is! Block ||
            !value.startsWith('// ') && !(value == '//' && (precedingComments.previous != null || precedingComments.next != null))) {
          return precedingComments;
        }
      }
